<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayitOl.aspx.cs" Inherits="Proje1_OkulKayit.KayitOl" %>
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Kullanıcı Adınız.."></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Mail Adresi</label>
                     <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="mail@gmail.com"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Sehriniz</label>
                         <asp:TextBox ID="TextBox3" runat="server" class="form-control" placeholder="Şehriniz.."></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şifreniz</label>
                         <asp:TextBox ID="TextBox4" runat="server" class="form-control" placeholder="**********" TextMode="Password"></asp:TextBox>
                    </div>
