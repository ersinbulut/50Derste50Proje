<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Proje3__TarimSitesi.Default" %>
		...
		<div class="container-fluid px-lg-4">
			<nav class="py-4">
                        <div class="logo" id="logo">
                            <a href="index.html">Proje 3</a>
                            
                        </div>
                        <label for="drop" class="toggle">Menu</label>
                        <input type="checkbox" id="drop">
                        <ul class="menu mt-md-3">
                            <li class="mr-lg-2 active"><a href="index.html">Ana Sayfa</a></li>
                            <li class="mr-lg-2"><a href="#about" class="scroll">Hakkımızda</a></li>
							<li class="mr-lg-2"><a href="#services" class="scroll">Servisler</a></li>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="style-banner">
					...
					<p class="mt-5 text-white">Organik ve Taze Baklagillerimizi Denemek İster misiniz?</p>
	 ...
	 <section class="wedo py-5" id="contact">
		<div class="container py-lg-5">
			<div class="text-center">
				...
				<p class="main_p mt-4 mb-4 pt-2 text-center mx-auto">Bizimle iletişime geçmek için aşağıdaki formu eksiksiz doldurunuz. </p>
			</div>
