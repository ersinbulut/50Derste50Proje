<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuncellemeSayfası.aspx.cs" Inherits="Proje4_AdminGiris.GuncellemeSayfası" %>
			...
			<div class="w3layouts-main">
				<%--<h2><span>Register now</span></h2>--%>
					<form action="#" method="post" runat="server">
                        ...
                        <asp:TextBox ID="TextBox2" runat="server" placeholder="KULLANICI ADI"></asp:TextBox>
                        <asp:TextBox ID="TextBox3" runat="server" placeholder="ŞİFRE" TextMode="Password"></asp:TextBox>
                        <asp:TextBox ID="TextBox4" runat="server" placeholder="ŞİFRE TEKRAR"></asp:TextBox>
